...
if __name__ == '__main__':
    ...
    #rawpath = "https://data.ontario.ca/dataset/e30dc044-5f75-4f33-b63e-6326f8769bea/resource/5fe1b9cc-5c3b-4f8f-99fc-2cacf41fcf9d/download/ctyoats_f.xlsx"
    #rawpath = "https://data.ontario.ca/dataset/e30dc044-5f75-4f33-b63e-6326f8769bea/resource/ba7cbd73-c6a5-4533-b3e2-608a8c7a548b/download/ctysoy_f.xlsx"
    #filepath = "/Users/genevieve/Documents/Travail/IVADO/Project/rendement_avoine_simple/data/raw/ctyoats_f.xlsx"
        
    if validators.url(filepath):
        # datadir serait normalement définie dans un fichier de configuration
        datadir = "/Users/genevieve/Documents/Travail/IVADO/Project/rendement_avoine_simple/"
        destdir = os.path.join(datadir, "data/raw")
        filepath = save_file(filepath, destdir)
